...
SCENARIOS = {
    ...
    "competing_maintenance": ScenarioDefinition(
        "competing_maintenance", "Competing Maintenance", "Adds one optional Engineering task competing for the Kurla-Chembur UP corridor and Engineering resource.", "CP-SAT should preserve mandatory feasibility and avoid corridor/resource overlap; the optional task may be rejected.", transform=_add_competing_maintenance, modifications=("add SCN-ENG-001",),
    ),
    "corridor_closure": ScenarioDefinition(
        "corridor_closure", "Corridor Closure", "Adds a temporary locked full-block closure on Thane-Kurla UP.", "Affected candidates should be removed while mandatory feasibility remains enforced.", transform=_add_corridor_closure, modifications=("close Thane-Kurla UP from 00:30 to 02:00",),
    ),
}
